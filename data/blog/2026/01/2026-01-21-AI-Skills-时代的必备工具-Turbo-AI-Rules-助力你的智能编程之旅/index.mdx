...
或直接访问: [Open VSX Registry](https://open-vsx.org/extension/ygqygq2/turbo-ai-rules)
...
- 📖 [使用指南](https://github.com/ygqygq2/turbo-ai-rules/blob/main/docs/user-guide/README.md)
