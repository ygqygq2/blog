...
# CentOS7 离线安装 docker 问题解决

[TOC]

因某些环境，不能联外网，所以使用 docker yum 源方法行不通，于是打算离线安装。 按此博客的方法http://www.cnblogs.com/aguncn/p/6863710.html，下载相应rpm安装。
...
总结： 安装 docker rpm 前，需要使用 `yum -y install systemd-devel systemd-libs libseccomp device-mapper-libs` 这些 rpm 包，可使用 CentOS7 官方 ISO 制作成本地 yum 源安装。
