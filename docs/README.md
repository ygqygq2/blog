...
3. **[📋 环境变量配置](./02-deployment/02-environment-variables.md)** 🆕
   - 本地开发和生产环境配置
   - 安全最佳实践
   - 多平台部署设置

4. **[💬 评论系统配置](./02-deployment/03-comments-setup.md)** 🆕
   - Giscus 评论系统集成
...
| **配置环境变量** | [环境变量配置](./02-deployment/02-environment-variables.md)         |
| **启用评论功能** | [评论系统配置](./02-deployment/03-comments-setup.md)                |
